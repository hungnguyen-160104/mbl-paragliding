...
// Hàm hỗ trợ định dạng ngày tháng sang định dạng tiếng Việt
...
// ✅ Hàm xác định API Base hoạt động trên mọi môi trường
function getApiBase() {
  return (
...
async function getBlogPosts() {
  ...
  const res = await fetch(`${base}/api/posts?isPublished=true&category=news`, {
    cache: "no-store",
    headers: { "Content-Type": "application/json" },
  });
  if (!res.ok) {
    console.error("❌ Fetch blog posts failed:", res.statusText);
