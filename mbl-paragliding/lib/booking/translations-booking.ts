  ...
  vi: {
    ...
    messages: {
      ...
      preflightNotes: [
        ...
        "Trang phục: nên đi giày thể thao; không đi giày cao gót; quần áo dài tay màu sắc sặc sỡ; có thể đeo kính; chuẩn bị ~4GB bộ nhớ trống để nhận ảnh/video.",
        "Toạ độ điểm bay:",
      ],
      errors: {
        dateInPast:
